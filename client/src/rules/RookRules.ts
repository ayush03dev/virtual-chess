...
export const rookMove = (initialPosition: Position, desiredPosition: Position, color: PieceColor, boardState: Piece[]): boolean => {
...
export const getPossibleRookMoves = (rook: Piece, boardstate: Piece[]): Position[] => {
    ...
    for (let i = 1; i < 8; i++) {
        ...
        } else if (tileIsOccupiedByOpponent(destination, boardstate, rook.color)) {
            possibleMoves.push(destination);
            break;
        } else {
            break;
